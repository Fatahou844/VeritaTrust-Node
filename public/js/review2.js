...
productReviewArray.forEach(div => {
    ...
    const merchand = document.querySelector('#review'+i.toString());
    const stars = merchand.querySelectorAll('.star-review');
    const reviewValue = document.querySelector('#review-value'+i.toString());
    const reviewValueText = document.querySelector('#review-value-text'+i.toString());
