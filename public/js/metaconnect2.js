...
const loginWithMetamask = async () => {
  ...
  if (window.web3) {
    try {
      ...
      document.cookie = 'userWalletAddress=' + selectedAccount + ";expires=Fri, 31 Jan 2023 12:00:00 UTC; path=/" ;
...
window.onload=function() {
   // when the user clicks the login button run the loginWithEth function  metaloginbtnbody
document.querySelector("#metaloginbtn").addEventListener("click", loginWithMetamask);
document.querySelector("#metaloginbtnbody").addEventListener("click", loginWithMetamask);
