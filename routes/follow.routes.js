...
const verifyAccess = (req, res, next) => {
  ...
  if (req.user.id === req.body.follower_userId) {
...
// // Create a new follow
router.post("/", passport.authenticate("jwt", { session: false }), verifyAccess, createfollow);

router.get("/followers/:id", getfollowers);
router.get("/followings/:id", getfollowings);
router.put("/unfollow/:id", passport.authenticate("jwt", { session: false }),verifyAccess, deleteFollow);
