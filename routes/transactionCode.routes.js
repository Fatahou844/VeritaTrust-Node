...
router.post("/", passport.authenticate("jwt", { session: false }), createtransactionCode);

router.post("/verifyCode",passport.authenticate("jwt", { session: false }), verifyCode);

router.get("/:validationCode",passport.authenticate("jwt", { session: false }), gettransactionCodebyCode);
