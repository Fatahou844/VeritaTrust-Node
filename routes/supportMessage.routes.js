...
const {
  ...
  getsupportMessages,
  getsupportMessageByReportReviewId
} = require("../controllers/supportMessage.controller");
...
router.post("/", passport.authenticate("jwt", { session: false }),verifyAccess,  createsupportMessage);
router.get("/", getsupportMessages);
router.get("/:reportreviewid", getsupportMessageByReportReviewId);
