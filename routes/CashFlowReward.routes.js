...
const {
  createCashFlowReward,
  getCashFlowRewards,
  getCashFlowRewardByUserId
} = require("../controllers/CashFlowReward.controller");
...
router.post("/", createCashFlowReward);
router.get("/",isAuthenticatedAdmin, getCashFlowRewards);
router.get("/:userId",passport.authenticate("jwt", { session: false }),verifyAccess, getCashFlowRewardByUserId);
