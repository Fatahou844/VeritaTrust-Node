...
const sendCodeTransaction = async (userid, validationCode) => {
  const sql = `SELECT * FROM userprofile  where id = ${userid}`;
  db.sequelize
    ...
    .then((result) => {
      ...
      result.forEach((element) => {
        ...
        smtpTemplate.templateName = "Your validation code";
		      	...
		      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td style="padding: 2.5em; text-align: left;">
							<div class="">
								<p>Best regards,<br><a href="https://api.veritatrust.com/user-dashboard/${userid}">veritatrust.com</a> team</p>
							</div>
						</td>
					</tr>
		      	</table>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
        ...
        <tr>
          <td class="bg_white unsubscribe" style="text-align: center;">
          	<p>You no longer wish to receive these e-mails? You can <a href="http://dev.veritatrust.com/unsuscribe?user=${element.email}&sender=0">Unsubscribe here</a></p>
          </td>
        </tr>
      </table>
        ...
        smtpTemplate.subject = "Using this code to validate your transaction";
        smtpTemplate.replyTo = "no_reply@veritatrust.com";
        smtpTemplate.toField = element.email;
...
module.exports = {
  sendCodeTransaction: sendCodeTransaction,
};
