const resetPasswordNotif = async (
  first_name,
  last_name,
  confirmation_link,
  email_recipient
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
            	...
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
							...
							Please click this button to reset your password:</p>
	      	...
	      	<td class="bg_white" style="padding: 0 0 1em 0;">
		      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<td valign="middle" style="text-align:center; padding: 0 2.5em;">
						<span><a href="${confirmation_link}" class="btn btn-primary">Reset your password</a></span>
						</td>
					</tr>
					<tr>
      ...
      smtpTemplate.subject = "Please reset your password";
...
module.exports = {
  resetPasswordNotif: resetPasswordNotif,
};
