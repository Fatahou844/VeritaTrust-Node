...
const emailProductInvitation = nodeCron.schedule("*/20 * * * * *", function cronJob() {

    console.log("emailProductInvitation run", new Date().toLocaleString());
    ...
    try {
        ...
        dbConn.query(
            ...
            "SELECT * FROM invitations where Delivery_status = 'Not delivered' and invitation_type = 'product_review' and has_sent != 1 and TIMEDIFF(CURRENT_TIMESTAMP ,Created_at) >= '00:00:50'",
            ...
            function(err, result) {
                ...
                result.forEach((element) => {
                    ...
                    /*** ajouter une partie de code pour récupérer l adresse email du client: proprietaire de la boutique

                     * on va faire une requette SELECT dans la table merchant_profile
                    ...
                    dbConn.query(
                        ...
                        "SELECT * FROM merchant_profile WHERE id = ?",
                        ...
                        function(error, res) {
                            ...
                            res.forEach((ele) => {
                                ...
                                // Récuperation des images et nom dans le url invitation
                                
                                var data = element.invitation_url_complete.split('&');
                                var images_url = data[5];
                                var product_names = data[6];
                                var product_ids = data[4];
                                images_url = images_url.replace('image=','');
                                product_names = product_names.replace('name=','');
                                product_ids = product_ids.replace('productid=','');
                                
                                var product_names_array = product_names.split(',');
                                var images_url_array = images_url.split(',');
                                var l = images_url_array.length;
                                ...
                                for(var i = 0; i<l; i++)
                                {
                                    bloc =   bloc + `<p><strong>How would you rate this product: ${product_names_array[i]} ?</strong></p>
                                               <p style="text-align:center;"><img src=${images_url_array[i]} alt="" width="150" height="150"></p>
                                               <p style="text-align:center;"><a class="btn btn-primary" style="margin-bottom: 0;" href=` +
        ...
        <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #fafafa;">
            ...
            <center style="width: 100%; background-color: #f1f1f1;">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                        ...
                        <tr>
                            ...
                            <td class="bg_white" style="text-align: left; padding: 20px 20px 0 20px;">
                                ...
                                <p>Dear ${firstname}  ${lastname},<br> You are receiving this email because you recently purchased on ${domaine_name}</p> ` + bloc +
                ...
                <a class="btn btn-primary" style="margin-bottom: 0;" href=` +
                    ...
                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto; font-size: 15px;">
                        ...
                        <tr>
                            ...
                            dbConn.query(
                                    ...
                                    "SELECT subscription.merchant_profile_id, subscription.user_profile_id, subscription.subscribed FROM subscription WHERE subscription.merchant_profile_id = ? AND subscription.user_profile_id = ((SELECT user_profile.id FROM user_profile WHERE user_profile.email = ?)) AND subscription.subscribed = 1",

                                    [customer_merchant_id, element.Recipient],
                                    ...
                                    function(err, r) {
                                        ...
                                        r.forEach((e) => {
                                                              ...
                                                              console.log('API called successfully. Returned data: ' + data);
                                                               ...
                                                               dbConn.query("UPDATE invitations SET message_id = ? WHERE invitation_url = ? and invitation_type = 'product_review'", [data['messageId'], element.invitation_url], function (err, res) {
                                                                if(err) {
                                ...
                                dbConn.query(
                                    ...
                                    "UPDATE invitations SET Sent_at = CURRENT_TIMESTAMP  WHERE Reference_number = ? and invitation_type = 'product_review'",
                               ...
                               dbConn.query(
                                    ...
                                    "UPDATE invitations SET has_sent = ? WHERE Reference_number = ? and invitation_type = 'product_review'", [1, element.Reference_number],  function(err, result) {
                    ...
                    ); //fin de query merchant profile

                }); // Fin de for each element.
...
module.exports.emailProductInvitation = emailProductInvitation;