          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			...
          			<td class="logo veritatrust" style="text-align: right;">
						<a href="https://api.veritatrust.com/">
            	...
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
							...
							Congratulations! Your review about <a href="https://api.veritatrust.com/en/${reviewtype}/${reviewid}/?stars=">${domaine_name}</a> is on the blockchain.</p>
	      	...
	      	<td class="bg_white" style="padding: 0 0 1em 0;">
		      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<td valign="middle" style="text-align:center; padding: 0 2.5em;">
						<span><a href="https://api.veritatrust.com/en/${reviewtype}/${reviewid}/?stars=" class="btn btn-primary">Check your review!</a></span>
						</td>
					</tr>
					<tr>
						<td style="padding: 2.5em; text-align: left;">
							<div class="">
								<p>Best regards,<br><a href="https://api.veritatrust.com/en/${reviewtype}/${reviewid}/?stars=">${domaine_name}</a> team</p>
							</div>
						</td>
					</tr>
		      	</table>
