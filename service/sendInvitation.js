...
const emailInvitation = nodeCron.schedule("*/20 * * * * *", function cronJob() {
    ...
    try {
        ...
        dbConn.query(
            ...
            "SELECT * FROM invitations where Delivery_status = 'Not delivered' and invitation_type = 'merchant_review' and has_sent != 1 and TIMEDIFF(CURRENT_TIMESTAMP ,Created_at) >= '00:00:25'",
                        ...
                        <tr>
                            ...
                            dbConn.query(
                                    ...
                                    function(err, r) {
                                        ...
                                        r.forEach((e) => {
                                                              ...
                                                              console.log('API called successfully. Returned data: ' + data);
                                                               ...
                                                               dbConn.query("UPDATE invitations SET message_id = ? WHERE invitation_url = ? and invitation_type = 'merchant_review'", [data['messageId'], element.invitation_url], function (err, res) {
                                                                if(err) {
                                ...
                                dbConn.query(
                                    ...
                                    "UPDATE invitations SET Sent_at = CURRENT_TIMESTAMP  WHERE Reference_number = ? and invitation_type = 'merchant_review'",
                               ...
                               dbConn.query(
                                    ...
                                    "UPDATE invitations SET has_sent = ? WHERE Reference_number = ? and invitation_type = 'merchant_review'", [1, element.Reference_number],  function(err, result) {
